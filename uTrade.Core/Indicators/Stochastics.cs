...
namespace uTrade.Core
{
	...
	public partial class Strategy
	{
		...
		public Stochastics Stochastics(Datas data, int periodD, int periodK, int smooth)
		{
			return Indicator.Stochastics(data.High, data.Low, data.Close, periodD, periodK, smooth);
		}
		...
		public Stochastics KD(Datas data, int periodD, int periodK, int smooth)
		{
			return Indicator.Stochastics(data.High, data.Low, data.Close, periodD, periodK, smooth);
		}
	}
