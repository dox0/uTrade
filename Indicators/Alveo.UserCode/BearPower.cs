...
namespace Alveo.UserCode
{
	...
	public class BearPower : IndicatorBase
	{
		...
		[Category("Settings"), Description("Period of the Bears Power Indicator")]
		...
		[Category("Settings"), Description("Price type on witch Bear Power will be calculated"), DisplayName("Price Type")]
		...
		protected override int Init()
		{
			...
			base.SetIndexBuffer(0, this.BearsBuffer, false);
		...
		protected override int Start()
		{
			...
			else
			{
				...
				{
					this.BearsBuffer[i, true] = base.Low[i, true] - this.TempBuffer[i, true];
				}
				result = 0;
			}
			return result;
